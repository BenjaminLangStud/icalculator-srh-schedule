...
[![Automatic Dependency Submission](https://github.com/BenjaminLangStud/icalculator-srh-schedule/actions/workflows/dependency-graph/auto-submission/badge.svg)](https://github.com/BenjaminLangStud/icalculator-srh-schedule/actions/workflows/dependency-graph/auto-submission)

# icalculator

The icalculator is an application which writes the lesson times to an output file. Optionally adds some padding to the start and end of the lecture
